...
const confirmPath = getTrialPath("a1", "trial1-5", "confirm")
const productPath = getTrialPath("a1", "trial1-5", "product");
...
export default function CheckoutPageA1Trial1_5({ searchParams }: Props) {
