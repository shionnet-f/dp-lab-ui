...
const confirmPath = getTrialPath("a1", "trial9", "confirm")
const productPath = getTrialPath("a1", "trial9", "product");
...
export default function CheckoutPageA1Trial9({ searchParams }: Props) {
