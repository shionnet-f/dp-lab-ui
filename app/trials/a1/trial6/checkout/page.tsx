...
const confirmPath = getTrialPath("a1", "trial6", "confirm")
const productPath = getTrialPath("a1", "trial6", "product");
...
export default function CheckoutPageA1Trial6({ searchParams }: Props) {
