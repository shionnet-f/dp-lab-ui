...
const checkoutPath = getTrialPath("a1", "trial6", "checkout");
        ...
        <section className="mx-auto grid h-[816px] w-[1160px] grid-cols-2 grid-rows-[378px_378px] gap-x-[60px] gap-y-[60px] overflow-hidden">
          {products.map((product) => (
            <ProductCard
              ...
              dpArea={
                product.dpDisplay?.showCountdown ? (
                  <div className="flex h-full items-center justify-center rounded-md bg-rose-50 px-3 text-[16px] font-semibold leading-[42px] text-rose-700">
