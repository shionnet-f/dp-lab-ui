...
function CountdownInfo({ show, secondsLeft }: CountdownInfoProps) {
  return (
    <div className="h-11 overflow-hidden">
      {show ? (
        <div className="flex h-full items-center rounded-md bg-rose-50 px-3 py-2 text-sm text-rose-700">
            ...
            <div className="grid grid-rows-[160px_140px_120px_1fr] gap-5">
              <section className="overflow-hidden rounded-xl border-2 border-gray-300 p-4">
                <div className="flex h-full flex-col justify-start">
                  {showCountdown ? (
                    <div className="mb-3 rounded-md bg-rose-50 px-3 py-2 text-sm font-medium text-rose-700">
                      セール終了まで {formatCountdown(secondsLeft)}
                    </div>
                  ) : (
