...
const confirmPath = getTrialPath("a1", "trial1-4", "confirm")
const productPath = getTrialPath("a1", "trial1-4", "product");
...
export default function CheckoutPageA1Trial1_4({ searchParams }: Props) {
