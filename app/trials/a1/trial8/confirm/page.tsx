...
const highestShippingPrice = Math.max(
  ...trial8Data.shippingMethods.map((method) => method.priceYen),
);
...
export default async function ConfirmPageA1Trial8({ searchParams }: Props) {
          ...
          <section className="grid h-full grid-cols-[1.5fr_1fr] gap-6">
            <div className="grid h-full grid-rows-[180px_110px_1fr] gap-6">
              ...
              <article className="overflow-hidden rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
                ...
                <div className="flex items-center justify-between text-sm text-gray-700">
                  <span>{shippingInfo ? shippingInfo.name : "未選択"}</span>
                  <span>
                    {shippingInfo ? getShippingDisplayText(shippingInfo.priceYen) : "未選択"}
                  </span>
                </div>
              </article>
            ...
            <div className="grid h-full grid-rows-[1fr_auto] overflow-hidden rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
              ...
              <div className="grid gap-3 pt-6">
                <Link
                  href={`/trials/a1/trial8/complete?${completeParams.toString()}`}
                ...
                <Link
                  href={`/trials/a1/trial8/checkout?${backParams.toString()}`}
