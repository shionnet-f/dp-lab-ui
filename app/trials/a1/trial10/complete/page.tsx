...
export default function CompletePageA1Trial11() {
  return (
    <main className="flex h-screen items-center justify-center bg-gray-50 px-6">
      <div className="w-full max-w-xl rounded-xl border border-gray-200 bg-white p-8 text-center shadow-sm space-y-4">
        <h1 className="text-xl font-bold text-gray-900">購入手続き完了です</h1>

        <Link
          href="/trials/a1/trial11/start"
