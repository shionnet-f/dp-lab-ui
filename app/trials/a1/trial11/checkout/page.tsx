...
function getShippingDisplayText(key: string) {
  const price = shippingPrices[key];
  const diff = highestShippingPrice - price;
              ...
              <div className="space-y-4 text-sm text-gray-700">
                <label className="flex items-start gap-3 rounded-md border border-gray-200 px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900">
                      {getShippingDisplayText("standard")}
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3 rounded-md border border-gray-200 px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900">
                      {getShippingDisplayText("express")}
                    </div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3 rounded-md border border-gray-200 px-4 py-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-gray-900">
                      {getShippingDisplayText("scheduled")}
                    </div>
                  </div>
                </label>
              </div>
