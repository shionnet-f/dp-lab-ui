...
export default function CheckoutPageA1Trial12({ searchParams }: Props) {
  ...
  return (
    <main className="h-screen overflow-hidden bg-gray-50 px-8 py-8">
      <div className="mx-auto flex h-full max-w-6xl flex-col">
        ...
        <form
          action="/trials/a1/trial12/confirm"
          method="GET"
          ...
          <aside className="flex h-full flex-col rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <div className="mt-auto space-y-6 text-gray-900">
              ...
              <div className="space-y-3 pt-4">
                <button
                  type="submit"
                  className="w-full rounded-md bg-black px-4 py-3 text-sm font-medium text-white cursor-pointer"
                >
                  次へ進む
                </button>

                <Link
                  href="/trials/a1/trial12/product"
