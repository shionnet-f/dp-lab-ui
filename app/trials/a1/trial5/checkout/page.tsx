...
const confirmPath = getTrialPath("a1", "trial5", "confirm")
const productPath = getTrialPath("a1", "trial5", "product");
...
export default function CheckoutPageA1Trial5({ searchParams }: Props) {
