...
const confirmPath = getTrialPath("b1", "trial6", "confirm");
const productPath = getTrialPath("b1", "trial6", "product");
...
export default function CheckoutPageB1Trial6({ searchParams }: Props) {
