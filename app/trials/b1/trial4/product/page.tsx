            ...
            <div className="grid grid-rows-[260px_150px_150px] gap-5">
              ...
              <section className="overflow-hidden rounded-xl border-2 border-gray-300 p-4">
                <div className="flex h-full flex-col">
                  ...
                  <div className="flex-1 space-y-2 overflow-y-auto text-sm leading-6 text-gray-600">
              ...
              <section className="overflow-hidden rounded-xl border-2 border-gray-300 p-4">
                <div className="flex h-full flex-col">
                  ...
                  <div className="flex-1 space-y-2 overflow-y-auto text-sm text-gray-600">
            ...
            <div className="grid grid-rows-[160px_140px_120px_1fr] gap-5">
              ...
              <section className="rounded-xl border-2 border-gray-300 p-4">
                <div className="flex h-full items-end">
                  <Link
                    href={`/trials/b1/trial4/checkout?productId=${product.id}&set=${set}`}
...
export default function ProductPageB1Trial4() {
