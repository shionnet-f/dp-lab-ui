...
const completePath = getTrialPath("b1", "trial4", "complete");
const checkoutPath = getTrialPath("b1", "trial4", "checkout");

export default function ConfirmPageB1Trial4() {
  ...
  const selectedShippingForDisplay = selectedShipping
      ...
      <div className="mx-auto h-[1080px] w-[1200px] overflow-hidden">
        ...
        <section className="flex h-[915px] gap-[60px]">
          ...
          <div className="h-[915px] w-[620px]">
            ...
            {/* 配送方法 */}
            <ConfirmShippingSection shippingMethod={selectedShippingForDisplay} />
