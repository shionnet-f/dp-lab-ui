...
const confirmPath = getTrialPath("b1", "trial5", "confirm");
const productPath = getTrialPath("b1", "trial5", "product");
...
export default function CheckoutPageB1Trial5({ searchParams }: Props) {
