...
const confirmPath = getTrialPath("b1", "trial1-5", "confirm");
const productPath = getTrialPath("b1", "trial1-5", "product");
...
export default function CheckoutPageB1Trial1_5({ searchParams }: Props) {
