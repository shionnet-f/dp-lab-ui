...
const completePath = getTrialPath("b1", "trial8", "complete");
const checkoutPath = getTrialPath("b1", "trial8", "checkout");

export default function ConfirmPageB1Trial8() {
