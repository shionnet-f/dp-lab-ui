...
export default function CheckoutPageA2Trial11({ searchParams }: Props) {
  ...
  return (
    <main className="h-screen overflow-hidden bg-gray-50 px-8 py-8">
      <div className="mx-auto flex h-full max-w-6xl flex-col">
        ...
        <form
          action="/trials/a2/trial11/confirm"
          method="GET"
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <label className="flex items-start gap-3 rounded-md border border-gray-100 bg-gray-50 px-3 py-2">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500">{getShippingDisplayText(500)}</div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3 rounded-md border border-gray-100 bg-gray-50 px-3 py-2">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500">{getShippingDisplayText(800)}</div>
                  </div>
                </label>
                ...
                <label className="flex items-start gap-3 rounded-md border border-gray-100 bg-gray-50 px-3 py-2">
                  ...
                  <div>
                    ...
                    <div className="text-gray-500">{getShippingDisplayText(700)}</div>
                  </div>
                </label>
              </div>
            </article>
          ...
          <section className="rounded-xl border border-gray-200 bg-white px-6 py-6 shadow-sm">
            <div className="grid h-full grid-cols-[1fr_auto] items-center gap-8">
              ...
              <div className="grid grid-cols-2 gap-3">
                <Link
                  href="/trials/a2/trial11/product"
