      ...
      >
        <div className="rounded-2xl bg-white">
          ...
          <div className="space-y-5 px-6 py-6">
            <section className="rounded-xl border border-gray-200 p-5">
              <div className="grid grid-cols-[160px_1fr] items-center gap-5">
                ...
                <div className="min-w-0">
                  ...
                  {product.dpDisplay?.emphasizeFreeShipping ? (
                    <div className="mt-3 text-sm font-bold text-red-600">送料無料</div>
                  ) : null}
                </div>
              </div>
            </section>
            ...
            <div className="pt-1">
              <Link
                href={`/trials/a2/trial11/checkout?productId=${product.id}&set=${set}`}
...
function ProductCard({ product, set }: { product: Trial11Product; set: string }) {
  return (
