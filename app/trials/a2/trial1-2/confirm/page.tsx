...
const completePath = getTrialPath("a2", "trial1-2", "complete");
const checkoutPath = getTrialPath("a2", "trial1-2", "checkout");
...
export default function ConfirmPageA2Trial1_2({ searchParams }: Props) {
