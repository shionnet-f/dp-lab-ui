...
const confirmPath = getTrialPath("a2", "trial1-2", "confirm");
const productPath = getTrialPath("a2", "trial1-2", "product");
...
export default function CheckoutPageA2Trial1_2({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial1_2Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial1_2Data.options.filter((option) =>
