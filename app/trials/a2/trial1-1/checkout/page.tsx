...
const confirmPath = getTrialPath("a2", "trial1-1", "confirm");
const productPath = getTrialPath("a2", "trial1-1", "product");
...
export default function CheckoutPageA2Trial1_1({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial1_1Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial1_1Data.options.filter((option) =>
