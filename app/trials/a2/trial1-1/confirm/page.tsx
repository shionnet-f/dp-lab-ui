...
const completePath = getTrialPath("a2", "trial1-1", "complete");
const checkoutPath = getTrialPath("a2", "trial1-1", "checkout");
...
export default function ConfirmPageA2Trial1_1({ searchParams }: Props) {
