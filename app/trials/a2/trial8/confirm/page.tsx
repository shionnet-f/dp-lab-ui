...
const completePath = getTrialPath("a2", "trial8", "complete");
const checkoutPath = getTrialPath("a2", "trial8", "checkout");
...
export default function ConfirmPageA2Trial8({ searchParams }: Props) {
