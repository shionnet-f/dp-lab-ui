      ...
      >
        <div className="rounded-2xl bg-white">
          ...
          <div className="space-y-5 px-6 py-6">
            ...
            <div className="pt-1">
              <Link
                href={`/trials/a2/trial12/checkout?productId=${product.id}`}
    ...
    <article className="h-[104px] rounded-xl border border-gray-200 bg-white px-5 shadow-sm">
      <div className="grid h-full grid-cols-[112px_1fr_260px] items-center gap-5">
        ...
        <div className="min-w-0">
          <h2
            className={[
              "line-clamp-1 text-gray-900 transition-all",
              isTextHighlighted
          ...
          <p
            className={[
              "mt-2 text-gray-800 transition-all",
              isTextHighlighted
    ...
    <main className="h-screen overflow-hidden bg-gray-50 px-8 py-8">
      <div className="mx-auto flex h-full max-w-6xl flex-col">
        ...
        <section className="grid flex-1 gap-5">
          <ProductCard product={products6[0]} isTextHighlighted />
