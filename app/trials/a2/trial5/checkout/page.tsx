...
const confirmPath = getTrialPath("a2", "trial5", "confirm");
const productPath = getTrialPath("a2", "trial5", "product");
...
export default function CheckoutPageA2Trial5({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial5Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial5Data.options.filter((option) =>
        ...
        >
          ...
          <section className="grid h-[438px] w-[1160px] grid-cols-[550px_550px] gap-[60px] overflow-hidden">
            <ShippingMethodSection
              shippingMethods={trial5Data.shippingMethods}
