...
const completePath = getTrialPath("a2", "trial5", "complete");
const checkoutPath = getTrialPath("a2", "trial5", "checkout");
...
export default function ConfirmPageA2Trial5({ searchParams }: Props) {
