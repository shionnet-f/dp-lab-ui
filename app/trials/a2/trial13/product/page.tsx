      ...
      >
        <div className="rounded-2xl bg-white">
          ...
          <div className="space-y-5 px-6 py-6">
            ...
            <div className="pt-1">
              <Link
                href={`/trials/a2/trial13/checkout?productId=${product.id}`}
...
function ProductCard({ product, index }: { product: Product; index: number }) {
  ...
  return (
    <article className="h-[104px] rounded-xl border border-gray-200 bg-white px-5 shadow-sm">
      <div className="grid h-full grid-cols-[112px_1fr_220px_260px] items-center gap-5">
        ...
        <div className="min-w-0 text-sm leading-5 text-gray-500">
          {detail.isDpTarget
            ? '仕様・補足にセット構成の案内があります'
            : ''}
        </div>
