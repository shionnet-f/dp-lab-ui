...
const confirmPath = getTrialPath("a2", "trial1-3", "confirm");
const productPath = getTrialPath("a2", "trial1-3", "product");
...
export default function CheckoutPageA2Trial1_3({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial1_3Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial1_3Data.options.filter((option) =>
