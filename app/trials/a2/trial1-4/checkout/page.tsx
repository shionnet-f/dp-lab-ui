...
const confirmPath = getTrialPath("a2", "trial1-4", "confirm");
const productPath = getTrialPath("a2", "trial1-4", "product");
...
export default function CheckoutPageA2Trial1_4({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial1_4Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial1_4Data.options.filter((option) =>
        ...
        >
          ...
          <section className="grid h-[438px] w-[1160px] grid-cols-[550px_550px] gap-[60px] overflow-hidden">
            <ShippingMethodSection
              shippingMethods={trial1_4Data.shippingMethods}
