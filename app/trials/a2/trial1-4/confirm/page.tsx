...
const completePath = getTrialPath("a2", "trial1-4", "complete");
const checkoutPath = getTrialPath("a2", "trial1-4", "checkout");
...
export default function ConfirmPageA2Trial1_4({ searchParams }: Props) {
