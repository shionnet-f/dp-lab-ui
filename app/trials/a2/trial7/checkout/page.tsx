...
const confirmPath = getTrialPath("a2", "trial7", "confirm");
const productPath = getTrialPath("a2", "trial7", "product");
...
export default function CheckoutPageA2Trial7({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial7Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial7Data.options.filter((option) =>
