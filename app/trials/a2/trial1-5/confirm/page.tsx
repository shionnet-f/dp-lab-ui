...
const completePath = getTrialPath("a2", "trial1-5", "complete");
const checkoutPath = getTrialPath("a2", "trial1-5", "checkout");
...
export default function ConfirmPageA2Trial1_5({ searchParams }: Props) {
