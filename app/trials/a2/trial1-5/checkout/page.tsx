...
const confirmPath = getTrialPath("a2", "trial1-5", "confirm");
const productPath = getTrialPath("a2", "trial1-5", "product");
...
export default function CheckoutPageA2Trial1_5({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial1_5Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial1_5Data.options.filter((option) =>
        ...
        >
          ...
          <section className="grid h-[438px] w-[1160px] grid-cols-[550px_550px] gap-[60px] overflow-hidden">
            <ShippingMethodSection
              shippingMethods={trial1_5Data.shippingMethods}
              selectedShipping={shipping}
              onChangeShipping={setShipping}
            />

            <OptionSection
              options={trial1_5Data.options}
