...
const completePath = getTrialPath("a2", "trial4", "complete");
const checkoutPath = getTrialPath("a2", "trial4", "checkout");
...
export default function ConfirmPageA2Trial4({ searchParams }: Props) {
