...
const confirmPath = getTrialPath("a2", "trial4", "confirm");
const productPath = getTrialPath("a2", "trial4", "product");
...
export default function CheckoutPageA2Trial4({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    trial4Data.shippingMethods.find((method) => method.id === shipping) ?? null;

  const selectedOptionItems = trial4Data.options.filter((option) =>
