...
const completePath = getTrialPath("b2", "trial1-4", "complete");
const checkoutPath = getTrialPath("b2", "trial1-4", "checkout");
...
export default function ConfirmPageB2Trial14({ searchParams }: Props) {
