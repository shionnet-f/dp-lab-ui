...
const completePath = getTrialPath("b2", "trial1-1", "complete");
const checkoutPath = getTrialPath("b2", "trial1-1", "checkout");
...
export default function ConfirmPageB2Trial11({ searchParams }: Props) {
