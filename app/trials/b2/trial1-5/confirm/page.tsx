...
const completePath = getTrialPath("b2", "trial1-5", "complete");
const checkoutPath = getTrialPath("b2", "trial1-5", "checkout");
...
export default function ConfirmPageB2Trial15({ searchParams }: Props) {
