...
import { getOptionsByIds, getProductById, getShippingById, trial1_2Data } from "../data";
...
export default function ConfirmPageB2Trial1_2() {
  ...
  const handleSubmit = () => {
    ...
    router.push(`/trials/b2/trial1-2/complete?${completeParams.toString()}`);
  };
        ...
        <div className="grid flex-1 grid-rows-[152px_228px_176px_120px_88px] gap-6">
          ...
          <section className="rounded-xl border border-gray-200 bg-white px-6 py-5 shadow-sm">
            <div className="flex h-full flex-col gap-3">
              ...
              <Link
                href={`/trials/b2/trial1-2/checkout?${backParams.toString()}`}
