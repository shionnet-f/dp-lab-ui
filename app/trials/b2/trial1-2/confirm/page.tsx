...
const completePath = getTrialPath("b2", "trial1-2", "complete");
const checkoutPath = getTrialPath("b2", "trial1-2", "checkout");
...
export default function ConfirmPageB2Trial12({ searchParams }: Props) {
