...
export default function CheckoutPageB2Trial1_2({ searchParams }: Props) {
  ...
  return (
    <main className="h-screen overflow-hidden bg-gray-50 px-8 py-8">
      <div className="mx-auto flex h-full max-w-6xl flex-col">
        ...
        <form
          action="/trials/b2/trial1-2/confirm"
          method="GET"
        ...
        >
          ...
          <section className="grid min-h-0 grid-cols-2 gap-5">
            <article className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                {trial1_2Data.shippingMethods.map((method) => (
                  <label
                    key={method.id}
            ...
            <article className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                {trial1_2Data.options.map((option) => (
                  <label
                    key={option.id}
                    className="flex items-start gap-3 rounded-md border border-gray-100 bg-gray-50 px-3 py-2"
                  >
          ...
          <section className="px-2 py-4 shrink-0">
            <div className="grid h-full grid-cols-2 gap-3">
              <Link
                href={`/trials/b2/trial1-2/product?set=${set}&trial=${trial}`}
