...
const completePath = getTrialPath("b2", "trial1-3", "complete");
const checkoutPath = getTrialPath("b2", "trial1-3", "checkout");
...
export default function ConfirmPageB2Trial13({ searchParams }: Props) {
