  ...
  return (
    <article className="flex h-[805px] w-[520px] flex-col overflow-hidden rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
      <div className="flex-1">
        <h2 className="mb-4 text-[22px] font-bold text-gray-900">
          お支払い金額
        </h2>
        ...
        <div className="rounded-md border border-gray-200 p-4">
          <div className="space-y-4 text-[18px] font-bold">
            <div className="flex items-center justify-between">
              <span className="text-gray-700">商品価格</span>
              <span className="text-gray-900">¥{yen(productPriceYen)}</span>
            </div>

            <div className="flex items-center justify-between">
              <span className="text-gray-700">送料</span>
            ...
            <div className="flex items-center justify-between border-t border-gray-200 pt-4">
              <span className="text-[20px] font-bold text-gray-900">合計</span>
