...
const completePath = getPracticePath("trial1-1", "complete");
const checkoutPath = getPracticePath("trial1-1", "checkout");

export default function ConfirmPagePracticeTrial1_1() {
