...
const productPath = getPracticePath("trial1-3", "product");
...
export default function CheckoutPagePracticeTrial1_3({ searchParams }: Props) {
  ...
  const selectedShippingMethod =
    practice1_3Data.shippingMethods.find((method) => method.id === shipping) ??
    null;

  const selectedOptionItems = practice1_3Data.options.filter((option) =>
        ...
        >
          ...
          <section className="grid h-[438px] w-[1160px] grid-cols-[550px_550px] gap-[60px] overflow-hidden">
            <ShippingMethodSection
              shippingMethods={practice1_3Data.shippingMethods}
              selectedShipping={shipping}
              onChangeShipping={setShipping}
            />

            <OptionSection
              options={practice1_3Data.options}
